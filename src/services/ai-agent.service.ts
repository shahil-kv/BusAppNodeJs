  ...
  try {
    ...
    if (hasEnglish) {
      ...
      if (
        ...
        lowerMessage.includes('നമസ്കാരം')
      ) {
        processedResponse =
          'നമസ്കാരം! ഞങ്ങളുടെ വിദ്യാഭ്യാസ പ്രോഗ്രാമുകളിൽ ചേരാൻ താല്പര്യമുണ്ടോ?';
      } else if (
        lowerMessage.includes('course') ||
        lowerMessage.includes('program') ||
        lowerMessage.includes('കോഴ്സ്')
      ) {
        processedResponse =
          'ഞങ്ങൾക്ക് ടെക്നോളജി, ഹെൽത്ത്‌കെയർ, ബിസിനസ് എന്നീ മേഖലകളിൽ മികച്ച കോഴ്സുകൾ ഉണ്ട്. ഏത് മേഖലയിലാണ് നിങ്ങൾക്ക് താല്പര്യം?';
      } else if (
        lowerMessage.includes('price') ||
        lowerMessage.includes('cost') ||
        lowerMessage.includes('വില')
      ) {
        processedResponse =
          'ഞങ്ങളുടെ കോഴ്സുകൾ ₹20,000 മുതൽ ₹35,000 വരെ ചിലവാകും. EMI ഓപ്ഷനുകളും ലഭ്യമാണ്. കൂടുതൽ വിവരങ്ങൾക്ക് ഞങ്ങളുടെ കൗൺസിലറുമായി സംസാരിക്കാം.';
      } else if (
        lowerMessage.includes('technology') ||
        lowerMessage.includes('tech') ||
        lowerMessage.includes('ടെക്')
      ) {
        processedResponse =
          'ഞങ്ങൾക്ക് ഫുൾ സ്റ്റാക്ക് ഡെവലപ്മെന്റ്, സോഫ്റ്റ്വെയർ എഞ്ചിനീയറിംഗ് എന്നീ ടെക് കോഴ്സുകൾ ഉണ്ട്. ഏതാണ് നിങ്ങൾക്ക് താല്പര്യം?';
      } else if (
        lowerMessage.includes('healthcare') ||
        lowerMessage.includes('health') ||
        lowerMessage.includes('ഹെൽത്ത്')
      ) {
        processedResponse =
          'ഞങ്ങൾക്ക് നഴ്സിംഗ് അസിസ്റ്റന്റ്, മെഡിക്കൽ കോഡിംഗ് എന്നീ ഹെൽത്ത്‌കെയർ കോഴ്സുകൾ ഉണ്ട്. ഏതാണ് നിങ്ങൾക്ക് താല്പര്യം?';
      } else if (lowerMessage.includes('business') || lowerMessage.includes('ബിസിനസ്')) {
        processedResponse =
          'ഞങ്ങൾക്ക് ബിസിനസ് മാനേജ്മെന്റ്, ഡിജിറ്റൽ മാർക്കറ്റിംഗ് എന്നീ ബിസിനസ് കോഴ്സുകൾ ഉണ്ട്. ഏതാണ് നിങ്ങൾക്ക് താല്പര്യം?';
      } else if (
        lowerMessage.includes('yes') ||
        lowerMessage.includes('അതെ') ||
        lowerMessage.includes('ഉണ്ട്')
      ) {
        processedResponse =
          'മികച്ചത്! നിങ്ങളുടെ വിവരങ്ങൾ എടുക്കാൻ തുടങ്ങാം. നിങ്ങളുടെ പേര് എന്താണ്?';
      } else if (
        lowerMessage.includes('no') ||
        lowerMessage.includes('ഇല്ല') ||
        lowerMessage.includes('അല്ല')
      ) {
        processedResponse =
          'പ്രശ്നമില്ല! ഞങ്ങൾക്ക് മറ്റ് പല കോഴ്സുകളും ഉണ്ട്. ഞങ്ങളുടെ കൗൺസിലറുമായി സംസാരിക്കാൻ താല്പര്യമുണ്ടോ?';
      } else {
        processedResponse =
          'നിങ്ങളുടെ ചോദ്യത്തിന് ഉത്തരം നൽകാൻ എനിക്ക് സന്തോഷമുണ്ട്. ഞങ്ങളുടെ വിദ്യാഭ്യാസ പ്രോഗ്രാമുകളെക്കുറിച്ച് കൂടുതൽ അറിയാൻ താല്പര്യമുണ്ടോ?';
      }
    }
    ...
    if (
      ...
      !processedResponse.includes('എന്ന്') &&
      !processedResponse.includes('ആണ്') &&
      !processedResponse.includes('നന്ദി')
    ) {
